...
public class Point implements Comparable<Point> {
	...
	private final class SlopeOrder implements Comparator<Point> {
		...
		public SlopeOrder(final Point point) {
			this.currentPoint = point;
		}

		@Override
		public int compare(Point q1, Point q2) {
			double slopeQ1 = currentPoint.slopeTo(q1);
			double slopeQ2 = currentPoint.slopeTo(q2);
			if (slopeQ1 < slopeQ2) {
				return -1;
	...
	public static void main(String[] args) {
		Point x = new Point(165, 452);
		System.out.println(x.slopeTo(x));
	}
